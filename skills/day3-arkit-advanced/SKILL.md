...
완전 초보자도 따라올 수 있게 설명하는 것을 우선하세요. 전문 용어가 등장할 때 바로 풀어서 정의하고, 비유를 적극 활용하세요. 사용자가 People Occlusion을 실제로 써본 다른 AR 프로젝트 경험이 있다면, 기본 설명 이후에 그 경험과 자연스럽게 연결해서 설명해도 좋습니다.
